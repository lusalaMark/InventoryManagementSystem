using InventoryManagementSystem.CoreBusiness.Validations;
using System;
...
namespace InventoryManagementSystem.CoreBusiness
{
    public class Product
    {
        ...
        {
            if (!this.ProductInventories.Any(x => x.Inventory != null && x.Inventory.InventoryName.Equals(inventory.InventoryName)))
            {
